  ...
  return (
    <div >
      ...
      <header className="hero-section" style={{
        ...
        <div id="home-hero-overlay" className="home-hero-overlay"></div>
          <div id="home-hero-overlay-container" className="home-hero-overlay-container">
            <div id="home-hero-overlay-content" className="home-hero-overlay-content">
              <h3 id="home-overlay-welcome-text" className="home-overlay-welcome-text">Welcome to</h3>
              <h1 id="home-overlay-title" className="home-overlay-title">Quezon City Animal Care & Adoption Center</h1>
              <p id="home-overlay-text" className="home-overlay-text">{typedText}</p>
              <p id="home-overlay-description" className="home-overlay-description">
                Layunin ng Animal Care and Adoption Center na bigyan ng bagong buhay ang mga aso at pusang nahuli mula sa mga kalsada ng Quezon City.
              </p>
              <a id="home-contact-btn" href="#contact-us" className="home-hero-overlay-contactus-btn">Contact Us</a>
            </div>
          </div>
      </header>
